...
$_SESSION["lastPage"] = "teacherDashboard.php";
?>
            ...
            <div class="cards">
                <div class="card-single">
                    <div>
                        <?php
                        if ($_SESSION['accountType'] == 'teacher') {
                            $query = "SELECT COUNT(*) as compteurSeanceValidee FROM tp WHERE IDProfesseur = '" . $_SESSION['utilisateur_ID'] . "' and StatusSession = 1 ";
                            $exec_requete = mysqli_query($db_handle, $query);
                ...
                <div class="card-single">
                    <div>
                        <?php
                        if ($_SESSION['accountType'] == 'teacher') {
                            $query = "SELECT COUNT(*) as compteurSeanceRefusee FROM tp WHERE IDProfesseur = '" . $_SESSION['utilisateur_ID'] . "' and StatusSession = 2 ";
                            $exec_requete = mysqli_query($db_handle, $query);
                ...
                <div class="card-single">
                    <div>
                        <?php
                        $query = "SELECT COUNT(*) as nombreHeureNonValidee FROM tp where StatusSession = 0 and IDProfesseur = '" . $_SESSION['utilisateur_ID'] . "'";
                        $exec_requete = mysqli_query($db_handle, $query);
