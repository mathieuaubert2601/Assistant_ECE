...
$_SESSION["lastPage"] = "teacherManagment.php";
?>
                                        ...
                                        if ($exec_requete) {
                                            ...
                                            if ($num_rows > 0) {
                                                while (($data = mysqli_fetch_assoc($exec_requete))) {
                                                    ...
                                                    $idSession = $idProfesseur;

                                                    echo "<tr>";
                                                    echo "<td>$idProfesseur</td>";
                                                    echo "<td>$firstName</td>";
                                                    echo "<td>$lastName</td>";
                                                    echo "<td>$email</td>";
                                                    if ($status == 0) {
                                                        echo '<td><span class="status-seance color-three"></span>';
                                                        echo '<form method="GET" action="deleteTeacherProcessing.php" class="apercuHeureAValider">';
                                                        ...
                                                        echo '<form method="GET" action="validateTeacherProcessing.php" class="apercuHeureAValider">';
